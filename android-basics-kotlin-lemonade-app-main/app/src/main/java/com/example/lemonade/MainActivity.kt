...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        when(this.squeezeCount){
            ...
            -1 -> {
                setViewElements(2)
                this.squeezeCount += 1
                this.lemonQuantity = this.lemonTree.pick()
            }
            this.lemonQuantity+1 -> {
                setViewElements(1)
                this.squeezeCount += 1
            }
            this.lemonQuantity+2 -> {
                setViewElements(0)
                this.squeezeCount = -1
            }
            else -> this.squeezeCount += 1
     ...
     */
    private fun setViewElements(value:Int) {
